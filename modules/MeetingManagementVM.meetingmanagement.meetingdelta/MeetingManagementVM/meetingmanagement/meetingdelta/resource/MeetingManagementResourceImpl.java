...
public class MeetingManagementResourceImpl extends MeetingManagementResourceDecorator {
	...
	private MeetingManagementServiceImpl meetingmanagementmeetingdeltaServiceImpl = new MeetingManagementServiceImpl(
			recordComponent);
	...
	public List<HashMap<String, Object>> transformMeetingManagementListToHashMap(
			List<MeetingManagement> MeetingManagementMeetingDeltaList) {

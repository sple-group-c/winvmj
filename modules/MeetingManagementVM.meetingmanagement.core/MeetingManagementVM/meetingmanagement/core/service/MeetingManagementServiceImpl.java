...
public class MeetingManagementServiceImpl extends MeetingManagementServiceComponent {
	...
	public MeetingManagement createMeetingManagement(Map<String, Object> requestBody) {
		...
		MeetingManagement meetingmanagement = MeetingManagementFactory.createMeetingManagement(
				"MeetingManagementVM.meetingmanagement.core.model.MeetingManagementImpl", name, startDate, endDate, location);
	...
	public MeetingManagement createMeetingManagement(Map<String, Object> requestBody, int id) {
		...
		// to do: fix association attributes
		MeetingManagement meetingmanagement = MeetingManagementFactory.createMeetingManagement(
				"MeetingManagementVM.meetingmanagement.core.model.MeetingManagementImpl", idMeeting, name, startDate, endDate,
				location);
		Repository.saveObject(meetingmanagement);
		return meetingmanagement;
	}
